...
module.exports = [
    body('nombre').notEmpty().withMessage('Debes poner tu nombre.').isLength({
        min: 2,
        max: 60
    }).isAlpha().withMessage('El nombre debe contener solo letras.'),

    body('apellido').notEmpty().withMessage('Debes poner tu apellido.').isAlpha().withMessage('El apellido debe contener solo letras.'),
